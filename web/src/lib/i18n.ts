// Minimal DE/EN dictionary + a reactive language store (Vue 3 reactivity).
...
// Reactive singleton store. Same public API as the old Svelte runes class
// (`i18n.lang`, `i18n.t(...)`, `i18n.toggle()`), so ported components only
// need to swap the import path `$lib/i18n.svelte` -> `$lib/i18n`.

...
const de = {
	...
	stack_items: [
		...
		['Web', 'Vue 3 · d3 · Cloudflare Pages'],
		['Daten-Hosting', 'HuggingFace Dataset (öffentlich)']
	] as [string, string][],
	inspiration:
		'OpenBundestag ist eine unabhängige Neuimplementierung, inspiriert von Open Discourse (opendiscourse.de).',
	cta: 'Daten erkunden',
...
const en = {
	...
	inspiration:
		'OpenBundestag is an independent reimplementation inspired by Open Discourse (opendiscourse.de).',
	cta: 'Explore the data',
	github: 'Source code on GitHub',
	dataset: 'Dataset on HuggingFace'
};

const c = computed(() => (i18n.lang === 'de' ? de : en));
watchEffect(() => {
	document.title = `${c.value.title} · OpenBundestag`;
});
</script>
		...
		<div class="body">
			...
			<section class="section">
				...
				<table class="stack-table">
					<tbody>
						<tr v-for="([label, value], i) in c.stack_items" :key="i">
			...
			<div class="cta-row">
				<RouterLink class="btn" to="/explore">{{ c.cta }} →</RouterLink>
				<a
					class="btn--ghost btn"

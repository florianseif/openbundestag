...
@click.option(
    ...
    is_flag=True,
    default=False,
    help="In the finalize phase, drop the raw speech_content column after "
         "building search_text (~halves DB size; the app never displays raw text).",
)
def main(phase: str, term: int, db: str, data_dir: str, slim: bool) -> None:
    ...
    if phase in ("finalize", "all"):
        ...
        finalize_db(db, drop_raw_text=slim)
